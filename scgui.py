...
class klutchguitool():
    def __init__(self): 
        ...
        if not os.path.exists(self.settingsfile):
            ...
            self.settings.set('launchoptions','game', '-novid -fullscreen -dxlevel 81 +fps_max 125')
            self.settings.set('launchoptions','demo', '-novid -sw -w 720 -h 480 +fps_max 125 +demoui')
